...
# Initialize the solution optimizer agent
solution_optimizer_agent = LlmAgent(
    name="solution_optimizer_agent",
    model=os.getenv("MODEL_NAME"),
    description="Optimizes and validates code solutions",
    instruction="""Optimize given solution. Format:
    **Heading** Optimized Solution
